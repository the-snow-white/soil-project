...
class OnionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val onionswebview: WebView = findViewById(R.id.onionswebView)
        // this will enable the javascript settings
        onionswebview.settings.javaScriptEnabled = true
        onionswebview.webViewClient = CustomWebViewClient(this, progressDialog)
        onionswebview.loadUrl("https://plantvillage.psu.edu/topics/onion/infos")
    }
